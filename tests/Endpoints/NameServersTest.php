...
class NameServersTest extends BaseEndpointTest
{
    ...
    public function it_can_do_a_create_ns_request()
    {
        ...
        $this->assertArraySubset(['reply' => ['code' => '0', 'desc' => [], 'data' => '1']], $nameServer);
    }
    ...
    public function it_can_do_a_create_template_dns_request()
    {
        ...
        $this->assertArraySubset(['reply' => ['code' => '0', 'desc' => [], 'data' => '5936']], $template);
    }
    ...
    public function it_can_do_a_create_zone_dns_request()
    {
        ...
        $this->assertArraySubset(['reply' => ['code' => '0', 'desc' => [], 'data' => '1']], $zone);
    }
    ...
    public function it_can_do_a_delete_template_dns_request()
    {
        ...
        $this->assertArraySubset(['reply' => ['code' => '0', 'desc' => [], 'data' => '1']], $template);
    }
    ...
    public function it_can_do_a_retrieve_ns_request()
    {
        ...
        $this->assertArraySubset(['reply' => ['code' => '0', 'desc' => [], 'data' => ['name' => 'glue-ns1.openprovider.com', 'ip' => '93.180.69.5', 'ip6' => '2a00:f10:11f::5']]], $nameServer);
    }
    ...
    public function it_can_do_a_search_ns_request()
    {
        ...
        $this->assertArraySubset(['reply' => ['code' => '0', 'desc' => [], 'data' => ['results' => ['array' => ['item' => [0 => ['name' => 'glue-ns1.openprovider.com', 'ip' => '93.180.69.5', 'ip6' => '2a00:f10:11f::5'], 1 => ['name' => 'glue-ns2.openprovider.com', 'ip' => '93.180.69.1', 'ip6' => '2a00:f10:11f::1']]]], 'total' => '2']]], $nameServer);
    }
    ...
    public function it_can_do_a_search_zone_dns_request()
    {
        ...
        $this->assertArraySubset(['reply' => ['code' => '0', 'desc' => [], 'data' => ['results' => ['array' => ['item' => ['id' => '48890', 'type' => 'master', 'name' => 'demozone.com', 'ip' => '89.255.0.43', 'active' => '1', 'creationDate' => '2010-07-13 17:07:22', 'modificationDate' => '2010-07-13 17:07:22']]], 'total' => '1']]], $zone);
    }
